...
#define FSL_MEM_DSP_TCM_END 0x00CFFFFFU
...
#define FSL_MEM_M33_ALIAS_END 0x204FFFFFU
/*
  This alias allows the DSP TCM to be mapped to the CM33 system address space without the need
  to enable and configure SMMU.
  DSP TCM addresses 0x0080_0000 to 0x00CF_FFFF are mapped to the CM33 system address space 0x2000_0000 to 0x204F_FFFF
*/
