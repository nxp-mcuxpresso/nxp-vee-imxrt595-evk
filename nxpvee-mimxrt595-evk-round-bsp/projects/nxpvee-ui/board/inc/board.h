...
#define BOARD_DEBUG_UART_BASEADDR PP_CONCAT((uint32_t) USART, BOARD_DEBUG_UART_INSTANCE)
#define BOARD_DEBUG_UART_CLK_FREQ CLOCK_GetFlexcommClkFreq(BOARD_DEBUG_UART_INSTANCE)
#define BOARD_DEBUG_UART_FRG_CLK \
    PP_CONCAT(((&(const clock_frg_clk_config_t){,BOARD_DEBUG_UART_INSTANCE) ## , kCLOCK_FrgPllDiv, 255U, 0U}) /*!< Select FRG0 mux as frg_pll */
#define BOARD_DEBUG_UART_CLK_ATTACH PP_CONCAT(kFRO_DIV4_to_FLEXCOMM, BOARD_DEBUG_UART_INSTANCE)
#define BOARD_UART_IRQ_HANDLER      PP_CONCAT(FLEXCOMM, BOARD_DEBUG_UART_INSTANCE) ## _IRQHandler
#define BOARD_UART_IRQ              PP_CONCAT(FLEXCOMM, BOARD_DEBUG_UART_INSTANCE) ## _IRQn
...
/* SWCLK pin */
#define BOARD_SWDIO_PORT                      2
#define BOARD_SWDIO_PIN                       26

/* Usart0 Rxd Pin */
#define BOARD_USART0_RXD_PORT                 0
#define BOARD_USART0_RXD_PIN                  2
 ...
 * API
 ******************************************************************************/
void GPIO_PortInit_noreset(GPIO_Type *base, uint32_t port);
