...
#define BOARD_DEBUG_UART_BASEADDR (uint32_t) USART12
#define BOARD_DEBUG_UART_INSTANCE 12U
#define BOARD_DEBUG_UART_CLK_FREQ CLOCK_GetFlexcommClkFreq(12)
#define BOARD_DEBUG_UART_FRG_CLK \
    (&(const clock_frg_clk_config_t){12U, kCLOCK_FrgPllDiv, 255U, 0U}) /*!< Select FRG0 mux as frg_pll */
#define BOARD_DEBUG_UART_CLK_ATTACH kFRO_DIV4_to_FLEXCOMM12
#define BOARD_UART_IRQ_HANDLER      FLEXCOMM12_IRQHandler
#define BOARD_UART_IRQ              FLEXCOMM12_IRQn
